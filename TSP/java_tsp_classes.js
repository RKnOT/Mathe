...
class UI_TSP{
    ...
    */
     ...
     var dic_array = this.convert_dic_to_array(this.dic);
	 	 ...
	 	 for(var i=0, len = dic_array[0].length; i<len; i++){
...
class get_Tour{
    ...
    get_random_points(nr_points, dez_stellen = 5){
          ...
          for(var i=0, len = nr_points; i<len; i++){
           var x = this.getRandomFloat(0, this.c_width, dez_stellen);
           var y = this.getRandomFloat(0, this.c_height, dez_stellen);
           points.push([x,y])
           }
          return points;
          }
